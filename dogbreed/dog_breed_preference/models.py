...
class BreedRank(models.Model):
    breed_id = models.OneToOneField(Breed, on_delete=models.CASCADE, to_field='breed_name', db_column='breed_name', related_name="rank")
...
class BreedTrait(models.Model):
    breed_name = models.OneToOneField(Breed, on_delete=models.CASCADE, to_field='breed_name', db_column='breed_name', related_name="traits")  
